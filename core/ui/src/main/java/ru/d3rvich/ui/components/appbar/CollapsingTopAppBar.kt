package ru.d3rvich.ui.components.appbar
...
class CollapsingTopAppBarColors(
    ...
    fun copy(
        ...
        actionsContentColor: Color = this.actionsContentColor,
    ): CollapsingTopAppBarColors = CollapsingTopAppBarColors(
        containerColor = containerColor,
        scrolledContainerColor = scrolledContainerColor,
        navigationIconContentColor = navigationIconContentColor,
        titleContentColor = titleContentColor,
        actionsContentColor = actionsContentColor
    )
}
